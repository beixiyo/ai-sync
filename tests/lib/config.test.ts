...
describe('config utils', () => {
  ...
  describe('tOOL_CONFIGS', () => {
    it('should have all required properties for cursor', () => {
      ...
      expect(config.supported).toEqual(['commands', 'skills', 'instructions', 'mcp', 'agents'])
    ...
    it('should have all required properties for claude', () => {
      ...
      expect(config.supported).toEqual(['commands', 'skills', 'mcp', 'settings', 'agents'])
      expect(config.mcp).toBeDefined()
    })
    ...
    it('should have all required properties for codebuddy', () => {
      ...
      expect(config.supported).toEqual(['commands', 'skills', 'instructions', 'mcp', 'settings', 'agents'])
      expect(config.mcp).toBeDefined()
